...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2025 at 08:07 AM
...
CREATE TABLE `dosen` (
  ...
  `alamat_dos` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(23, 'New Dosen', 'Jl.NewAddress'),
(33, 'New Dosen', 'Jl.NewAddress'),
(99, 'New Dosen', 'Jl.NewAddress');
...
('TKI333', 'Sistem Operasi', 3, 5, 10),
('TKI342', 'Praktikum Basis Data', 1, 3, 11);
